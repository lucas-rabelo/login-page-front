            ...
            {data.map((value) => (
              ...
              >
                <td className="px-6 py-4 text-center flex items-center justify-center gap-2">
                  <button
                    onClick={() => onEdit(value.uuid)}
                    className="bg-blue-100 hover:bg-blue-300 duration-300 rounded p-2"
                  >
                    <Pencil size={20} color="#1e40af" />
                  </button>
                  <button
                    onClick={() => onDelete(value.uuid)}
                    className="bg-red-100 hover:bg-red-300 duration-300 rounded p-2"
                  >
